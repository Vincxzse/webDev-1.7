...
<head>
    ...
    <title>Enchantress | Skin Products</title>
...
<body>
    ...
    <div class="navbar">
        ...
        <ul>
            ...
            <div class="dropdown">
                <a href="javascript:void(0)" class="dropper">Skin Products<img src="./pictures/down-arrow.png" alt="dropdown" /></a>
        ...
        <div class="main-container">
            ...
            <div class="slideshow-container">
                <?php
                    ...
                    $stmt = $pdo->prepare("SELECT content, content_picture, description FROM skin");
                    $stmt->execute();
